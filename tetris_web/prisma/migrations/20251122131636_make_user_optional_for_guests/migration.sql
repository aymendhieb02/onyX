...
INSERT INTO "new_room_players" ("avatar", "id", "lines", "ready", "roomId", "score", "status", "userId", "username") SELECT "avatar", "id", "lines", "ready", "roomId", "score", "status", "userId", "username" FROM "room_players";
